                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'SIGN_UP_PAGE_RichText_lluxj80b_ON_TAP');
                                        logFirebaseEvent(
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'SIGN_UP_PAGE_LOOK_AROUND_BTN_ON_TAP');
                                ...
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'SIGN_UP_PAGE_RichText_2ybecyt3_ON_TAP');
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'SIGN_UP_SIGNUP_WITH_GOOGLE_BTN_ON_TAP');
                                      logFirebaseEvent('Button_auth');
                                      GoRouter.of(context).prepareAuthEvent();
                                      final user = await authManager
                                ...
                                isAndroid
                                    ...
                                    : Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'SIGN_UP_SIGNUP_WITH_APPLE_BTN_ON_TAP');
                                            logFirebaseEvent('Button_auth');
                                            GoRouter.of(context)
                                                .prepareAuthEvent();
                                            final user = await authManager
