      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'PopularVideos')
              : NavBarPage(
        ...
        FFRoute(
          ...
          builder: (context, params) => SingleVideoWidget(
            ...
            channelThumbnail:
                params.getParam('channelThumbnail', ParamType.String),
            channelTitle: params.getParam('channelTitle', ParamType.String),
            channelId: params.getParam('channelId', ParamType.String),
            channelBanner: params.getParam('channelBanner', ParamType.String),
            allVideos:
                params.getParam<dynamic>('allVideos', ParamType.JSON, true),
          ),
        ),
        FFRoute(
          name: 'TheLab',
          path: '/theLab',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'TheLab')
              : NavBarPage(
                  initialPage: 'TheLab',
                  page: TheLabWidget(
                    channelData: params.getParam('channelData', ParamType.JSON),
                  ),
                ),
        ),
        FFRoute(
          name: 'SingleChannel',
          path: '/singleChannel',
          builder: (context, params) => SingleChannelWidget(
            channelThumbnail:
                params.getParam('channelThumbnail', ParamType.String),
            channelId: params.getParam('channelId', ParamType.String),
            channelTitle: params.getParam('channelTitle', ParamType.String),
        ...
        FFRoute(
          ...
          path: '/channels',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Channels')
              : NavBarPage(
                  initialPage: 'Channels',
                  page: ChannelsWidget(
                    channelData: params.getParam('channelData', ParamType.JSON),
                  ),
                ),
